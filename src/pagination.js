...
pagination.create = (currentPage, pageCount, queryObj) => {
	if (pageCount <= 1) {
		return {
	...
	pagesToShow = pagesToShow.filter((page, index, array) => page > 0 && page <= pageCount && array.indexOf(page) === index).sort((a, b) => a - b);
