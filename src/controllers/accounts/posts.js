...
postsController.getBookmarks = (req, res, next) => {
...
postsController.getUpVotedPosts = (req, res, next) => {
	getFromUserSet('account/upvoted', req, res, next);
};

postsController.getDownVotedPosts = (req, res, next) => {
	getFromUserSet('account/downvoted', req, res, next);
};

postsController.getBestPosts = (req, res, next) => {
	getFromUserSet('account/best', req, res, next);
};

postsController.getWatchedTopics = (req, res, next) => {
	getFromUserSet('account/watched', req, res, next);
};

postsController.getIgnoredTopics = (req, res, next) => {
	getFromUserSet('account/ignored', req, res, next);
};

postsController.getTopics = (req, res, next) => {
