...
usersController.banned = (req, res, next) => {
				...
				invites: (next) => {
					async.waterfall([
						...
						(_invitations, next) => {
							...
							async.map(invitations, (invites, next) => {
...
usersController.getCSV = (req, res, next) => {
