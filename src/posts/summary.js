...
module.exports = (Posts) => {
	Posts.getPostSummaryByPids = (pids, uid, options, callback) => {
		...
		async.waterfall([
			...
			(results, next) => {
				...
				posts = posts.filter(post => results.topics[post.tid]);
