...
Dependencies.checkModule = (moduleName, callback) => {
...
Dependencies.parseModuleData = (moduleName, pkgData) => {
	try {
...
Dependencies.doesSatisfy = (moduleData, packageJSONVersion) => {
	if (!moduleData) {
		return false;
	}
